...
export class Status {
  ...
  public get dto() : StatusDto {
    console.log("Does it get to acquiring the DTO?")
    return {
      post: this._post,
      // user: (this._user).dto,
      user: new User(this._user.dto.firstName, this._user.dto.lastName, this._user.dto.alias, this._user.dto.imageUrl),
  ...
  //   console.log("Received StatusDto:", dto);
  
  //   const user = User.fromDto(dto.user);
  //   console.log("User is ", user)
  //   if (user == null) {
  //     throw new Error("Invalid user data in StatusDto");
  //   }
  
  //   return new Status(dto.post, user, dto.time_stamp);
  // }

  public static fromDto(dto: StatusDto | null): Status | null {
    console.log("The dto is ... ", dto);
    console.log("dto user is ... ", dto?.user)
    return dto == null ? null : new Status(dto.post, new User(dto.user.firstName, dto.user.lastName, dto.user.alias, dto.user.imageUrl), dto.time_stamp); // This line is off
  }
